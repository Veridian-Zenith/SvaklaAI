...
void authenticate_user() {
  extern bool authenticate_user(const std::string &public_key_path,
...
void manage_local_memory() {
  extern void save_context(const std::string &filename,
...
void run_documentation_system() {
  std::cout << "Documentation system is running. Check the "
               "/usr/local/share/svaklaai/docs/ directory for documentation."
            << std::endl;
}
